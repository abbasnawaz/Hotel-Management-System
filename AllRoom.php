...
$sql = "SELECT room.R_id,room.R_number,room.floor,room.R_status,room_type.room_type FROM room JOIN room_type ON(room.roomtype_id=room_type.roomtype_id) ORDER BY room.floor;";
